---
tags: [personal, operating-manual, moc, judgement, strategy, money, business]
aliases: [The Operating Manual, Operating Manual, Second Brain]
date: 2026-08-31
status: index — live. Rewritten 31 Aug after the market research.
author: Claude — written at the user's request
---

# THE OPERATING MANUAL
### A second brain: memory, seven questions, and one business

> [!important] Start here, in this order
> **1 · [[00 Profile — The Memory]]** — the facts everything else is built on. Fix this first when anything changes.
> **2 · [[Due Diligence — What the Market Says]]** — the research that rewrote the rest of this folder.
> **3 · [[The Seven]]** — the prompt set, and how to run it. `/second-brain` executes it.
>
> The other seven notes are the answers. They are downstream of the two files above and should be re-run, not hand-edited, when a fact changes.
...
| # | Note | What it does |
| --- | --- | --- |
| 00 | [[00 Profile — The Memory]] | Who, what, how much, what's unknown. The context layer |
| — | [[Due Diligence — What the Market Says]] | Two ideas examined against evidence. Sources at foot |
| — | [[The Seven]] | The seven prompts, saved, with a re-run trigger table |
| 1 | [[Ten Things I Was Blind To]] | The highest-return ideas. Two new, one cut |
| 2 | [[The Mentor Session — Seven Ideas]] | Psychology and philosophy, incl. the uncomfortable one |
...
## Related
- [[Home]] · [[Three Tracks — An Honest Comparison]] · [[Expenses]] · [[ACPA(T) NBAA To-Do]] · [[The Day Plan — 80-20, Pomodoro and Practice]]
