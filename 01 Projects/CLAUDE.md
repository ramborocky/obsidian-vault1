...
- **Craft knowledge bases** (five, same note pattern throughout — principle → "For Kalemie" application → "Questions for AI"; use these directly rather than re-deriving theory from scratch):
